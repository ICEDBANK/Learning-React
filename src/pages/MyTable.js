...
function MyTable() {
    ...
    const lastNameHandler = (event) => { // Function to handle changes in the LastName input field
        setLastName(event.target.value); // Updating the state variable 'LastName' with the new value
    };

    const locationHandler = (event) => { // Function to handle changes in the Location input field
        setLocation(event.target.value); // Updating the state variable 'Location' with the new value
    };

    const currentAgeHandler = (event) => { // Function to handle changes in the currentAge input field
        setCurrentAge(event.target.value); // Updating the state variable 'currentAge' with the new value
    };
